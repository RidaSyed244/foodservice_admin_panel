...
class ApprovedDrivers extends ConsumerStatefulWidget {
  const ApprovedDrivers({super.key});

  @override
  ConsumerState<ApprovedDrivers> createState() => _ApprovedDriversState();
}

class _ApprovedDriversState extends ConsumerState<ApprovedDrivers> {
  @override
            ...
            if (data.docs.isEmpty) {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (driverModel.driverStatus == "Approved") {
                      return Column(
                        children: [
                          Padding(
